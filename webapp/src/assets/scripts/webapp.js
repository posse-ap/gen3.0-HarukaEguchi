      ...
      datasets: [
        {
          ...
          data: [0.5, 2.5, 4.5, 1, 3.5, 3.5, 4, 6, 7.5, 1.5, 4, 2, 5.5, 7, 8, 7.5, 3.5, 0.5, 0.5, 1, 4, 3, 5.5, 1.5, 6, 8, 8, 1.5, 0.5, 4, 1, 5], //グラフのデータ
...
(async() => {
  const myChart = await initializeChart()
})()
...
console.log(shareTwitter);
  ...
  function renderWeeks() {
    ...
    for (let i = 0; i <scrip weeksCount; i++) {
